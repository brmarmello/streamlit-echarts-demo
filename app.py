...
if __name__ == "__main__":
    ...
    with st.sidebar:
        st.markdown("---")
        st.markdown(
            '<h6>Orgulhosamente Produzido no Streamlit &nbsp<img src="https://streamlit.io/images/brand/streamlit-mark-color.png" alt="Streamlit logo" height="16">&nbsp <br> Por <a href="https://www.linkedin.com/in/brunomarmello">MarTechBM</a></h6>',
            unsafe_allow_html=True,
        )
        st.markdown(
            '<div style="margin-top: 0.75em;"><a href="https://www.buymeacoffee.com/brmarmello" target="_blank"><img src="https://cdn.buymeacoffee.com/buttons/default-orange.png" alt="Buy Me A Coffee" height="41" width="174"></a></div>',
            unsafe_allow_html=True,
        )
